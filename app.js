...
// Task routes
app.post('/api/tasks', authMiddleware, validateCreateTask, createTask)
app.get('/api/tasks', authMiddleware, getTasks)
app.get('/api/tasks/:taskId', authMiddleware, validateGetTaskById, getTaskById)
app.put('/api/tasks/:taskId', authMiddleware, validateUpdateTask, updateTask)
app.delete('/api/tasks/:taskId', authMiddleware, validateDeleteTask, deleteTask)
